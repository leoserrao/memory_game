function shuffle(array) {
  ...
  function win() {
    ...
    if (s % 60 < 10) {
        stats.textContent = "Você ganhou com: " + stars + " estrelas em " + movesCounter + " movimentos e com o tempo de: " + m + ":0" + s % 60;
    } else {
        stats.textContent = "Você ganhou com: " + stars + " estrelas em " + movesCounter + " movimentos e com o tempo de: " + m + ":" + s % 60;
    }
  }
